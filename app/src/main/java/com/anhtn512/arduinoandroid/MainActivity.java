        ...
        switch (requestCode) {
            case 101:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Snackbar.make(coordinatorLayout, "Request permission successful!", Snackbar.LENGTH_INDEFINITE).show();
                } else {
                    Snackbar.make(coordinatorLayout, "Failed request permission!", Snackbar.LENGTH_INDEFINITE).show();
                }
                break;
            default:
